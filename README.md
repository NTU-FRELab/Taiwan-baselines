...
2. **Date of data collection:** 2016-2023
...
5. **Recommended citation for this dataset:** Ribas-Deulofeu L, Lin YV, Hsiao WV, Liu Y-L, Château P-A, Wei C-H, Chen W-J, Denis V (2026). Data from: Establishing legal and benthic baselines of Taiwan’s coral ecosystems to inform effective conservation [Dataset]. Zenodo. https://doi.org/XXXXX

6. **Associated manuscript:** Ribas-Deulofeu L, Lin YV, Hsiao WV, Liu Y-L, Château P-A, Wei C-H, Chen W-J, Denis V (2026). Establishing legal and benthic baselines of Taiwan’s coral ecosystems to inform effective conservation [under review in Regional Studies in Marine Science]
